...
class BagCollection extends Component {
    render() {
        ...
        let products = getDealProducts(getProductsByDemo(this.props.products, "demo9"), "bag");

        return (
            <Tabs selectedTabClassName="show" defaultIndex={ 0 }>
                <div className="heading heading-flex mb-3">
                    <div className="heading-left">
                        <h2 className="title">Bags & Accessories</h2>
                    </div>
                ...
                <div className="row">
                    <div className="col-lg-3">
                        <Banner banner={ _data.demo9.categoryBanners[1] } />
                    </div>
