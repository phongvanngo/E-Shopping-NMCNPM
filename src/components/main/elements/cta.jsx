...
import { setParallax } from '../../../utils/utils';
    ...
    render(){
        return(
            <div className="main">
                ...
                <Breadcrumb title="Call To Action" parent1={ ["Elements","elements/list"] } />
                ...
                <div className="page-content pb-0">
                    ...
                    <div className="cta bg-image bg-dark pt-6 pb-7 mb-5 bg-parallax" style={ {backgroundImage: `url(assets/images/backgrounds/bg-large.jpg)`} }>
                        <div className="container">
                    ...
                    <div className="cta bg-image bg-dark pt-6 pb-7 bg-parallax" style={ {backgroundImage: `url(assets/images/backgrounds/bg-large.jpg)`} }>
                        <div className="container">
                            <div className="row justify-content-center">
                                <div className="col-sm-10 col-md-8 col-lg-6">
                                    <div className="cta-text text-center">
