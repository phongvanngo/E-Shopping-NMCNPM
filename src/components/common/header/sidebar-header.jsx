			...
			<div className="side-div">
				<div className="header sidebar">
					<div className="header-top">
						<Link to={ `${process.env.PUBLIC_URL}/demo/`} className="logo">
                            <img src={ `${process.env.PUBLIC_URL}/assets/images/demos/demo-23/logo.png` } alt="OLLA Logo" width="100" height="20" />
                        </Link>
					</div>
						...
						<nav className="main-nav">
                            <ul className="menu sf-arrows">
                                <li className="megamenu-container active">
                                    <Link to={ `${process.env.PUBLIC_URL}/demo/`} className="sf-with-ul">Home</Link>
                                        ...
                                        <div className="menu-col">
                                            ...
                                            <div className="demo-list">
                                                <div className="demo-item">
                                                    <Link to={ `${process.env.PUBLIC_URL}/demo-1` }>
                                ...
                                <li>
                                    ...
                                    <div className="megamenu demo left">
                                    	<div className="menu-col">
                                    		...
                                    		<ul>
		                                        <li><Link to={ `${process.env.PUBLIC_URL}/pages/about` }>Classic</Link></li>
		                                        <li><Link to={ `${process.env.PUBLIC_URL}/pages/listing` }>Listing</Link></li>
		                                        <li>
		                                        ...
		                                        <li>
		                                            ...
		                                            <ul className="sub-menu">
		                                                <li><Link to={ `${process.env.PUBLIC_URL}/blog/mask/2cols` }>Blog mask grid</Link></li>
		                                                <li><Link to={ `${process.env.PUBLIC_URL}/blog/masonry/2cols` }>Blog mask masonry</Link></li>
		                                            </ul>
		                                        </li>
		                                        <li>
