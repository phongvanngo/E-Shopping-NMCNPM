                        ...
                        <div className="row">
                            <div className="col-sm-12 col-lg-4">
                                <div className="widget widget-about">
                                    <img src={ `${process.env.PUBLIC_URL}/assets/images/demos/demo-7/logo-footer.png` } className="footer-logo" alt="Footer Logo" width="105" height="25"/>
                            ...
                            <div className="col-sm-4 col-lg-2">
                                <div className="widget">
                                    ...
                                    <ul className="widget-list">
                                        ...
                                        <li><Link  to={ `${process.env.PUBLIC_URL}/pages/contact` }> us</Link></li>
