import PageLoaderRouter from "src/common/PageLoader/PageLoaderRouter";
...
const AdminDashboard = lazy(() =>
  import("src/pages/AdminDashboard/AdminDashboard")
);
const AdminSignIn = lazy(() => import("src/pages/AdminSignIn/AdminSignIn"));
